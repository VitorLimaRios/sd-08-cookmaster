...
it.skip('5 - Crie um endpoint para visualizar uma receita específica', () => {
  let connection;
  let db;
...
it.skip('7 - Crie um endpoint para a edição de uma receita', () => {
  let connection;
  let db;
...
it.skip('8 - Crie um endpoint para a exclusão de uma receita', () => {
  let connection;
  let db;
...
it.skip('9 - Crie um endpoint para a adição de uma imagem a uma receita', () => {
  let connection;
  let db;
...
it.skip('10 - Crie um endpoint para acessar a imagem de uma receita', () => {
  let connection;
  let db;
